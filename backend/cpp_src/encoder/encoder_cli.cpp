...
int main(int argc, char* argv[]) {
    if (argc != 6) {
        std::cerr << "Usage: " << argv[0] << " <message> <logo_file_path> <output_file_path> <module_num_data> <module_size>" << std::endl;
        return 1;
    }
    ...
    int result = generate_picode(msg, filenameLogo, filenamePiCode, moduleNumData, moduleSize);
