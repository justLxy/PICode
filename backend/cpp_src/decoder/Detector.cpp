...
Ref<DetectorResult> Detector::detect() {
  ...
  if(dimensionTop-1 < picodedimension || dimensionRight-1 < picodedimension || dimensionTop != dimensionRight)
  {throw NotFoundException();}

  if(dimensionTop-1 > 81 || dimensionRight-1 > 81 )
    {throw NotFoundException();}



  if( (dimensionTop-1 - picodedimension)%4 != 0 || (dimensionRight-1 - picodedimension)%4 !=0 )
  {throw NotFoundException();}
...
/*
  ...
  transform = createTransform(topLeft, topRight, bottomLeft, bottomRight, sampledimension, sampledimension);
  bits = sampleGrid(image_, sampledimension, sampledimension, transform);
  ...
  Ref<DetectorResult> detectorResult(new DetectorResult(bits,points,dimensionTop-1));
